...
function resetPasswordField(passwordInput) {
    passwordInput.value = '';
    passwordInput.placeholder = 'New password';
    passwordInput.style.borderColor = '';
    // Reset des variables stockées
    passwordInput.getCurrentPassword = () => '';
    passwordInput.getNewPassword = () => '';
    passwordInput.getPasswordState = () => 'new';
}
...
function setupPasswordField(passwordInput) {
    ...
    passwordInput.getCurrentPassword = () => currentPassword;
    passwordInput.getNewPassword = () => passwordState === 'confirm' ? newPassword : '';
    passwordInput.getPasswordState = () => passwordState;
    passwordInput.resetPasswordField = () => {
...
async function savePasswordDirectly(currentPassword, newPassword) {
    const profileData = {
    ...
    try {
        ...
        if (result.ok) {
            ...
            const passwordInput = document.getElementById('passwordField');
            if (passwordInput && passwordInput.resetPasswordField) {
                passwordInput.resetPasswordField();
            }
        }
    }
...
export function cleanupSettingsHandlers() {
    // isOnSettingsPage = false;
}
