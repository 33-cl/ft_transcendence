export { landingHTML } from './landing.html.js';
...
export { friendListHTML, spectateFreind, initLoadingIcons, destroyLoadingIcons, initializeFriendListEventListeners, refreshFriendListStatus, startFriendListAutoRefresh, stopFriendListAutoRefresh, initializeAddFriendsButton, updateFriendRequestsBadge } from './friendList.html.js';
