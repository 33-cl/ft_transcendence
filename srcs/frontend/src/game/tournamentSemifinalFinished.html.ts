export const tournamentSemifinalFinishedHTML = (data?: any) => {
    ...
    // Build the message for the other semi-final
    ...
    // The main roomJoined listener in websocket.ts will handle starting the final
    // No listener is set here to avoid conflicts
