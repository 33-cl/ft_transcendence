 ...
 * - GET /users/:id/rank : Rang d'un utilisateur
 * - GET /users/leaderboard/around/:rank : Classement autour d'un rang
 */
export default async function leaderboardRoutes(fastify: FastifyInstance) {
  ...
  // GET /users/leaderboard/around/:rank - Classement autour d'un rang donné
