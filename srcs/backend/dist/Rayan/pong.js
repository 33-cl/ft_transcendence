...
export class PongGame {
        ...
        // Mode 1v1v1v1 : paddles[0]=A, paddles[1]=B, paddles[2]=C, paddles[3]=D
            ...
            if (idx !== -1) {
                ...
                // Paddle B et D : horizontaux (x bouge)
                    ...
                    console.log(`[BACKEND] Paddle ${player} moved from x=${oldX} to x=${this.state.paddles[idx].x} (direction=${direction})`);
                }
            }
        }
    ...
    update() {
        ...
        if (this.state.paddles && this.state.paddles.length === 4) {
            ...
            if (this.state.ballY - ballRadius < paddles[3].y + paddles[3].height &&
